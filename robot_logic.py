...
class GemstoneRobotController:
    ...
    def __init__(self, host="ws://192.168.4.1:81"):
        ...
        # Dynamically discovered drop zones
        self.drop_zones = {}
    ...
    def update(self):
        ...
        if self.state == "INIT":
            ...
            if self.stone_count == 0 or self._loaded_color is None:
                self.target_color = self.strategy.analyze_outer_ring_color(stones)
            else:
            ...
            self.target_stone = self.strategy.find_best_stone(stones, self.target_color, robot_pos)
            ...
            updated_stone = self.strategy.find_best_stone(stones, self.target_color, robot_pos)
            if updated_stone:
